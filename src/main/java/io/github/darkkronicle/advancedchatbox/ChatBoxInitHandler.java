...
public class ChatBoxInitHandler implements IInitializationHandler {
    ...
    public void registerModHandlers() {
        ...
        chatRegistry.register(ColorCodeFormatter::new, "commandcodeformatter", "advancedchatbox.config.chatformatter.commandcodeformatter", "advancedchatbox.config.commandcodeformatter.info.commandcolorer", true, false);
