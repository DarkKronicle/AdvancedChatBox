    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY) {
        if (this.window != null) {
            ...
            for (OrderedText message : this.messages) {
                ...
                DrawableHelper.fill(matrices, this.x - 1, j, this.x + this.width + 1, j + 12, ChatBoxConfigStorage.General.BACKGROUND_COLOR.config.getSimpleColor().color());
                if (message != null) {
    ...
    public class SuggestionWindow {
        ...
        public void render(MatrixStack matrices, int mouseX, int mouseY) {
            ...
            if (more) {
                ...
                DrawableHelper.fill(matrices, this.area.getX(), this.area.getY() - 1, this.area.getX() + this.area.getWidth(), this.area.getY(), ChatBoxConfigStorage.General.BACKGROUND_COLOR.config.getSimpleColor().color());
                DrawableHelper.fill(matrices, this.area.getX(), this.area.getY() + this.area.getHeight(), this.area.getX() + this.area.getWidth(), this.area.getY() + this.area.getHeight() + 1, ChatBoxConfigStorage.General.BACKGROUND_COLOR.config.getSimpleColor().color());
                int x;
                if (moreBelow) {
                    // Dotted
            ...
            for (int s = 0; s < suggestionSize; ++s) {
                ...
                DrawableHelper.fill(matrices, this.area.getX(), this.area.getY() + 12 * s, this.area.getX() + this.area.getWidth(), this.area.getY() + 12 * s + 12, ChatBoxConfigStorage.General.BACKGROUND_COLOR.config.getSimpleColor().color());
